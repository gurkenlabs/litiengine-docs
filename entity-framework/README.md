...
| Topic | Description |
| :--- | :--- |
| **[Default Entity Types](/docs/entity-framework/default-entity-types/)** | Explore built-in entities: `Creature`, `Prop`, `Emitter`, `LightSource`, `Trigger`, and `SoundSource`. |
| **[Props](/docs/entity-framework/props/)** | Learn how to place, customize, and destroy interactive props in your world. |
| **[Subscribe to Entity Events](/docs/entity-framework/subscribe-to-entity-events/)** | Hook into entity lifecycle events (`onMoved`, `onHit`, `onDying`, `onRendered`). |
| **[Annotations for Static Information](/docs/entity-framework/annotations-for-static-information/)** | Configure static attributes declaratively with `@EntityInfo`, `@MovementInfo`, and `@CombatInfo`. |
| **[Custom Entity Implementations](/docs/advanced/advanced-entity-knowledge/custom-entity-implementations/)** | Create complex, custom entity classes from scratch. |
| **[Custom MapObjectLoaders](/docs/advanced/custom-mapobjectloaders/)** | Map custom Tiled object types directly to your Java entity classes. |
