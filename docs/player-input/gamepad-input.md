...
description: Learn how to handle gamepad input in LITIENGINE using Input.gamepads()
  with Input4j for cross-platform controller support.
keywords: [LITIENGINE, gamepad, controller, Input4j, Xbox, button, axis, Java]
tags: [gamepad, controller, joystick, xbox, input4j, panama]
---
# Gamepad Input
