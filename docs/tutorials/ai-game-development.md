...
- :lucide-download:{ .lg .middle } **[Download AGENTS.md Template](../assets/templates/AGENTS.txt)**
...
- :lucide-bot:{ .lg .middle } **[utiLITI MCP Server Reference](../utiliti-editor/mcp-server.md)**

    ---

    Detailed specification for all 90+ raw primitives and semantic map mutation tools.

- :lucide-gamepad-2:{ .lg .middle } **[2D Platformer Tutorial](2d-platformer.md)**
