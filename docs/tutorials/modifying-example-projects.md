...
To install Gradle, follow the official [Gradle Installation Guide](https://gradle.org/install/). For more specific setup instructions, visit our **[Build Systems Guide](../getting-started/build-systems.md)**.
