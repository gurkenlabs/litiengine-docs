...
Join the individual developers and community members who make LITIENGINE possible. Every contribution directly funds server costs, asset licensing, and community bounties.
...
Special thanks to the individual developers and community members who support LITIENGINE:
...
- Sponsor logos and links are provided for brand attribution and partner acknowledgement.
- Website directory placement and logo recognition begin at the Silver tier, while the Backers tier is dedicated to individual community supporters.
- All sponsor placements are subject to editorial review to ensure alignment with community standards and project values.
- Sponsorship does not influence technical decision-making, API architecture, or open-source governance.
