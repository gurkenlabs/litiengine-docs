...
- [Create and Manage Projects](create-projects.md) — Learn about `.litidata` project files, saving, and auto-backups.
- [User Interface & Workspaces](ui-and-workspaces.md) — Explore the layout, viewport controls, and panels.
- [Editing Tools & Viewport](tools-and-editing.md) — Master the pointer, tile brush, bucket fill, and Wang terrain tools.
