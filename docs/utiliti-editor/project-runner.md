...
Click the green **Run Project** button (:lucide-play:{ .middle style="color: #4caf50;" }) on the toolbar or press `Shift + F10`:
...
Click the **Debug Project** button (:lucide-bug:{ .middle style="color: #29b6f6;" }) on the toolbar or press `Shift + F9`:
...
### Setting Breakpoints:
- Click the left gutter of any line in the Monaco code editor. A red circle indicator (:lucide-circle:{ .middle style="color: #ef5350;" }) marks an active breakpoint.
